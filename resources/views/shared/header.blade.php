        ...
        <div class="sidebar-section flex-grow-1 d-flex flex-column w-100">
            ...
            <div class="py-3 px-4">
                ...
                <div class="progress w-100 my-2 height-1.25">
                    <div class="progress-bar bg-danger rounded" role="progressbar" style="width: {{ (Auth::user()->plan->features->pageviews == 0 ? 100 : (($stats['pageviews'] / Auth::user()->plan->features->pageviews) * 100)) }}%"></div>
                </div>
            </div>
